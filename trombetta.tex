...
\hypersetup{%
  ...
  urlcolor=blue,
  citecolor=blue,
  pdfauthor={John Trombetta},
  pdftitle={Running biomechanics and the effect of heel versus forefoot strike},
  pdfsubject={biology, biomechanics, kinesiology},
  pdfkeywords={shin splints, running, kinematics, ground reaction forces, kymograph}}
\usepackage{svg}
